	...
	?>
        ...
        <div>
            <section id="form1">
                <section class="row clearfix">
                    ...
                    <article class="cell">
                        <input type="text" name="firstname" class="required" id="firstname" value="<?php echo set_value('firstname'); ?>"><br/>
                        <label for="firstname">First Name<sup>*</sup></label>
                    </article>
					<article class="cell">
                        <input type="text" name="lastname" class="required" id="lastname" value="<?php echo set_value('lastname'); ?>"><br/>
                        <label for="lastname">Last Name<sup>*</sup></label>
                    </article>
                </section>
                <section class="row clearfix">
                    <label for="cust_title"><strong>Title<sup>*</sup></strong></label><br/>
                    <input type="text" name="cust_title" class="required" id="cust_title"value="<?php echo set_value('cust_title'); ?>">
                </section>
                <section class="row clearfix">
                    <label for="cust_company"><strong>Company<sup>*</sup></strong></label><br/>
                    <input type="text" name="cust_company" class="required" id="cust_company" value="<?php echo set_value('cust_company'); ?>">
                </section>
                <section class="row clearfix">
                    <label for="cust_phone"><strong>Contact's Phone<sup>*</sup></strong></label><br/>
                    <input type="text" name="cust_phone" class="required" id="cust_phone" value="<?php echo set_value('cust_phone'); ?>">
                </section>
				<section class="row clearfix">
					<label for="cust_email"><strong>Contact's Email<sup>*</sup></strong></label><br/>
					<input type="text" name="cust_email" class="required email" id="cust_email" value="<?php echo set_value('cust_email'); ?>">
				</section>
            </section>
        </div>
        ...
        <div>
            <section id="form2">
	            ...
	            <section class="row clearfix">
					...
					<article class="cell">
						<label for="ashford_formula"><strong>Ashford Formula<sup>&trade;</sup></strong><input type="checkbox" name="ashford_formula" id="ashford_formula" value="1"></label>

					</article>
		            <article class="cell">
			            <label for="retroplate"><strong>RetroPlate<sup>&reg;</sup></strong><input type="checkbox" name="retroplate" id="retroplate" value="1"></label>
                ...
                <section class="row clearfix">
                    ...
                    <input type="text" name="project_name" class="required" id="project_name" value="<?php echo set_value('project_name'); ?>">
                </section>
                <section class="row clearfix">
                    <label for="project_location"><strong>Project Location<sup>*</sup></strong></label><br/>
                    <input type="text" name="project_location" class="required" id="project_location" value="<?php echo set_value('project_location'); ?>"><br/>
                    <input type="text" name="project_location_2" id="project_location_2" value="<?php echo set_value('project_location_2'); ?>"><br/>
                    <input type="text" name="project_location_3" id="project_location_3" value="<?php echo set_value('project_location_3'); ?>"><br/>

                    <div class="clearfix">
                        <article class="cell">
                            <input type="text" name="project_city" class="required" id="project_city" value="<?php echo set_value('project_city'); ?>"><br/>
                            <label for="project_city">City</label>
                        </article>
                        <article class="cell">
                            <input type="text" name="project_state" class="" id="project_state" value="<?php echo set_value('project_state'); ?>"><br/>
                            <label for="project_state">State</label>
                        </article>
                        <article class="cell">
                            <input type="text" name="project_zip" class="" id="project_zip" value="<?php echo set_value('project_zip'); ?>"><br/>
                            <label for="project_zip">Zip/Postal</label>
                        </article>
                    </div>
                    <div class="clearfix">
                        <input type="text" name="project_country" class="required" id="project_country" value="<?php echo set_value('project_country'); ?>"><br/>
                ...
                <section class="row clearfix">
                    ...
                    <input type="text" name="company_owner_name" id="company_owner_name" value="<?php echo set_value('company_owner_name'); ?>">
                </section>
                <section class="row clearfix">
                    <label for="project_location"><strong>Address<sup>*</sup></strong></label><br/>
                    <input type="text" name="company_location" id="company_location" value="<?php echo set_value('company_location'); ?>"><br/>
                    <input type="text" name="company_location_2" id="company_location_2" value="<?php echo set_value('company_location_2'); ?>"><br/>
                    <input type="text" name="company_location_3" id="company_location_3" value="<?php echo set_value('company_location_3'); ?>"><br/>

                    <div class="clearfix">
                        <article class="cell">
                            <input type="text" name="company_city" id="company_city" value="<?php echo set_value('company_city'); ?>"><br/>
                            <label for="company_city">City</label>
                        </article>
                        <article class="cell">
                            <input type="text" name="company_state" id="company_state" value="<?php echo set_value('company_state'); ?>"><br/>
                            <label for="company_state">State</label>
                        </article>
                        <article class="cell">
                            <input type="text" name="company_zip" id="company_zip" value="<?php echo set_value('company_zip'); ?>"><br/>
                            <label for="company_zip">Zip/Postal</label>
                        </article>
                    </div>
                    <div class="clearfix">
                        <input type="text" name="company_country" id="company_country" value="<?php echo set_value('company_country'); ?>"><br/>
                ...
                <section class="row clearfix">
                    ...
                    <article class="cell">
	                    <input type="text" name="project_building_size" id="project_building_size" value="<?php echo set_value('project_building_size'); ?>">
                    </article>
	                <article class="cell" style="margin-left: 10px; margin-top: 10px;">
		                <label for="building_feet"><strong>ft<sup>2</sup></strong><input type="checkbox" name="building_feet" value="1"></label>
	                </article>
	                <article class="cell" style="margin-left: 10px; margin-top: 10px;">
		                <label for="building_meter"><strong>m<sup>2</sup></strong><input type="checkbox" name="building_meter" value="1"></label>
	                </article>
                </section>

	            <section class="row clearfix">
					<label for="project_concrete_amount"><strong>Amount of concrete treated with AF or RP<sup>*</sup></strong></label><br/>
		            <article class="cell">
			            <input type="text" name="project_concrete_amount" id="project_concrete_amount" value="<?php echo set_value('project_concrete_amount'); ?>">
		            </article>
		            <article class="cell" style="margin-left: 10px; margin-top: 10px;">
			            <label for="concrete_feet"><strong>ft<sup>2</sup></strong><input type="checkbox" name="concrete_feet" value="1"></label>
		            </article>
		            <article class="cell" style="margin-left: 10px; margin-top: 10px;">
			            <label for="concrete_meter"><strong>m<sup>2</sup></strong><input type="checkbox" name="concrete_meter" value="1"></label>
		            </article>
	            </section>

                <section class="row clearfix">
                    <label for="initial_application_date"><strong>Initial Application Date (Month/Year)<sup>*</sup></strong></label><br/>
                    <input type="text" name="initial_application_date" id="initial_application_date" value="<?php echo set_value('initial_application_date'); ?>">
                </section>
                <section class="row clearfix">
                    <label for="project_completion_date"><strong>Final Completion Date (Month/Year)<sup>*</sup></strong></label><br/>
                    <input type="text" name="project_completion_date" id="project_completion_date" value="<?php echo set_value('project_completion_date'); ?>">
                </section>
            </section>
        </div>
        ...
        <div>
            <section id="form3">
	            ...
	            <section class="row" style="margin-bottom: 25px;">
		            ...
		            <input type="text" name="applicator_name" id="applicator_name" class="required" value="<?php echo set_value('applicator_name'); ?>">
	            </section>

	            <h3>General Contractor</h3><br/>
	            <section class="row" style="margin-bottom: 25px;">
		            <label for="contractor_name"><strong>Concrete Contractor's Name</strong></label><br/>
		            <input type="text" name="contractor_name" id="contractor_name" value="<?php echo set_value('contractor_name'); ?>">
	            </section>

                <h3>Architect/Designer</h3><br/>
                <section class="row" style="margin-bottom: 25px;">
                    <label for="architect_name"><strong>Architect/Designer's Name</strong></label><br/>
                    <input type="text" name="architect_name" id="architect_name" value="<?php echo set_value('architect_name'); ?>">
                </section>
        ...
        <div>
            <section id="form4">
                ...
                <p>
                    <em>
	                    You hereby grant Curecrete Distribution, Inc. and Advanced Floor Products a perpetual, worldwide, non-exclusive license to use all submitted images in connection with this photo contest, including reproduction in any of Curecrete Distribution, Inc. and Advanced Floor Products’ print or electronic media products. Curecrete Distribution, Inc. and Advanced Floor Products shall also have the right to edit or modify the images in its sole discretion. You will retain ownership of all intellectual property in and to the images. You represent and warrant to Curecrete Distribution, Inc. and Advanced Floor Products that you own the images and/or are duly authorized to license them in the manner described herein, and that the submitted images do not infringe upon the intellectual property rights of any third party.
                    </em>
                </p>
                ...
                <section class="row">
                    ...
                    <input type="text" name="photographer_credit" class="required" id="photographer_credit" value="<?php echo set_value('photographer_credit'); ?>">
                </section>
                <section class="row clearfix">
                    <label><strong>Photographer Name<sup>*</sup></strong></label><br/>
                    <article class="cell">
                        <input type="text" name="photographer_first_name" class="required" id="photographer_first_name" value="<?php echo set_value('photographer_first_name'); ?>"><br/>
                        <label for="photographer_first_name">First Name</label>
                    </article>
                    <article class="cell">
                        <input type="text" name="photographer_last_name" class="required" id="photographer_last_name" id="photographer_first_name" value="<?php echo set_value('photographer_first_name'); ?>"><br/>
                ...
                <section class="row">
                    ...
                    <input type="text" name="photographer_phone" class="required" id="photographer_phone" value="<?php echo set_value('photographer_phone'); ?>">
                </section>
                <hr>
                <section class="row">
                    <label><strong>
                    ...
                    <textarea name="project_description" id="project_description"><?php echo set_value('project_description'); ?></textarea>
                    <p><em>A portion of this description will be published in the calendar as well as on our website. Projects
                            will be selected on such factors as innovative use of the Ashford Formula<sup>&trade;</sup> or RetroPlate<sup>&reg;</sup> product,
                ...
                <section class="row">
                    <article class="instructions">
                        ...
                        <p><strong>If you do not reach the "Thank You" screen and receive a confirmation email, your information was not submitted.</strong></p>
                        <p><em>If you experience problems with uploading, contact <a href="mailto:marketing@curecrete.com">marketing@curecrete.com</a></em></p>
                    </article>
                </section>
